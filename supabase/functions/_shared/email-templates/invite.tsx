...
const link = { color: 'hsl(220, 80%, 50%)', textDecoration: 'underline' }
const button = { backgroundColor: 'hsl(220, 80%, 50%)', color: '#ffffff', fontSize: '14px', borderRadius: '12px', padding: '12px 20px', textDecoration: 'none' }
const footer = { fontSize: '12px', color: 'hsl(220, 10%, 45%)', margin: '30px 0 0' }
