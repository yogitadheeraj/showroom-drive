...
import { Plus, Car, Edit2, MapPin, Palette, FileSpreadsheet, CalendarCheck, DollarSign, Zap, AlertCircle } from 'lucide-react';
...
const VehiclesPage = () => {
  ...
  const fetchVehicles = async () => {
    try {
      ...
      const rows = await apiGet<any[]>(`/api/vehicles?${params}`);
