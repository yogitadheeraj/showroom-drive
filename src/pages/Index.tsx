...
export default function AutoAdvantLandingPage({ initialContent = null }: AutoAdvantLandingPageProps) {
    ...
    return (
        <MarketingPageShell brandName={brand.dealerName} brandLogoUrl={brand.dealerLogoUrl}>
            <SeoMeta
                title={homeTitle}
                description={homeDescription}
                                    ...
                                    <div className="mt-4 rounded-2xl border border-white/10 bg-slate-800/70 p-4">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="mt-1 text-xs uppercase tracking-[0.2em] text-slate-500">Live overview</p>
                                            </div>
                                        ...
                                        <div className="mt-4 grid grid-cols-2 gap-2">
                                            {serviceBookingOverview.map((item) => (
                                                <div key={item.label} className="rounded-xl border border-slate-700 bg-gradient-to-br from-slate-900 to-slate-800 p-2.5 shadow-inner shadow-slate-950/40">
                                        ...
                                        <div className="mt-4 grid grid-cols-2 gap-2">
                                            {serviceInsights.map((insight) => (
                                                <div key={insight.label} className="rounded-xl border border-sky-400/20 bg-sky-500/5 px-2.5 py-2">
                                                    <p className="text-[10px] uppercase tracking-[0.16em] text-sky-200/80">{insight.label}</p>
