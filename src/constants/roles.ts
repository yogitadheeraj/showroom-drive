...
export const ROUTE_ALLOWED_ROLES = {
  ...
  BOOKINGS: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.SALES_ADMIN, APP_ROLE.GRO, APP_ROLE.SALES],
  ...
  REPORTS_MONITORING: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.SALES_ADMIN],
  ACTIVITY_LOGS: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.SALES_ADMIN, APP_ROLE.GRO, APP_ROLE.SALES, APP_ROLE.SECURITY],
  FLEET: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.SALES_ADMIN, APP_ROLE.SECURITY],
  INCOMING_VEHICLES: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.SALES_ADMIN, APP_ROLE.SECURITY, APP_ROLE.GRO, APP_ROLE.SALES],
} as const;