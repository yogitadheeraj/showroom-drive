...
export const ROUTE_ALLOWED_ROLES = {
  WALKIN: [APP_ROLE.GRO, APP_ROLE.DEALER_ADMIN, APP_ROLE.SALES],
  ENQUIRIES: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.GRO, APP_ROLE.SALES],
  LOCATIONS: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN],
  VEHICLES: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.GRO],
  USERS: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN],
  DATA_CENTER: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN],
  SETTINGS: [APP_ROLE.DEALER_ADMIN],
  REPORTS_MONITORING: [APP_ROLE.SUPERADMIN, APP_ROLE.DEALER_ADMIN, APP_ROLE.GRO],
} as const;